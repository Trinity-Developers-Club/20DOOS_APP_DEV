...
public class Splash extends AppCompatActivity {
        ...
        Button button;
        int hrs,mins,diff_hrs,diff_mins,x,u,hrS,minS,diff,diff1;
        int tHour,tMin;
...
//        });
            ...
            toCountry.setAdapter(new ArrayAdapter<>(Splash.this,android.R.layout.simple_spinner_dropdown_item,toCountries));
            ...
            fromCountry.setAdapter(new ArrayAdapter<>(Splash.this,android.R.layout.simple_spinner_dropdown_item,fromCountries));
